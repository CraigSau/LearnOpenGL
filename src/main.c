...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "STUPID TRIANGLES", NULL, NULL);
    ...
    // check for shader comiler errors
    int success;
    char infoLog[512];
    ...
    // You can unbind the VAO afterwards so other VAO calls won't accidently modify this VAO,
    // but this rarely happens. Modifying other VAO's requires a call to glBindVertexArray
